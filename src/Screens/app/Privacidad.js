...
Para el caso particular del proyecto denominado Sitio "Monitoreo Ciudadano" https://monitoreociudadano.uniandes.edu.co/, se tendrán en cuenta y aplicarán los siguientes puntos: 
  
1.    la Universidad tomará las precauciones y medidas necesarias para que los terceros, así como sus usuarios autorizados conozcan y respeten los términos y condiciones así como las restricciones de propiedad intelectual que tiene la base de datos y su buscador 
2.    Los usuarios registrados reportarán por escrito, mensaje de datos, o cualquier medio idóneo y de manera inmediata a la Universidad cualquier violación que conozca de la base de datos para que la Universidad tome las medidas que correspondan 
  
CONFIDENCIALIDAD: Tanto UNIANDES como los usuarios registrados, y en general cualquier tercero que tenga acceso a la presente información, así como todas y cada una de las personas que estén bajo su subordinación, se comprometen a conservar y mantener de manera estrictamente confidencial y no revelar a terceros, todas las informaciones y datos suministrados con ocasión del presente proyecto de Sitio Web "Monitoreo Ciudadano" https://monitoreociudadano.uniandes.edu.co/. Los aspectos relativos a confidencialidad se regirán por la reglamentación sobre Informaciones Confidenciales y Secretos Industriales de que tratan el Convenio de París sobre Propiedad Industrial, así como con lo establecido en los artículos 260 a 266 de la Decisión 486 de la Comisión del Acuerdo de Cartagena. Se exceptúa de lo dispuesto en la presente cláusula lo relativo al contenido material de las gacetas y en general todos los contenidos que son para conocimiento y difusión de la jurisprudencia nacional. 

DERECHOS DE PROPIEDAD INTELECTUAL: La Universidad de los Andes, mantendrá todos sus derechos de propiedad intelectual sobre cualquier obra, creación, información, conocimiento, tecnología o invención preexistentes que hayan desarrollado o adquirido antes, durante y después de llevar a cabo el proyecto denominado Sitio "Monitoreo Ciudadano" https://monitoreociudadano.uniandes.edu.co/, la cual podrá constar en forma impresa o electrónica, tangible o intangible. Dicha obra, creación, información, conocimiento, tecnología o invención estará sujeta a las obligaciones de confidencialidad y uso restringido establecidas por las partes. 

MANEJO Y ADMINISTRACIÓN DE BASES O BANCOS DE DATOS o cualquier clase de repositorios electrónicos: Toda persona que sea vinculada a la Universidad de los Andes bien sea a través de una relación laboral o por un contrato de prestación de servicios, o cualquier otro tipo; y que dentro de sus funciones o asignaciones tenga la de administrar, manejar, actualizar o llevar a cabo funciones específicas con respecto a toda clase de Bases o Banco de Datos cuyos derechos pertenezcan a la Universidad, deberá tener en cuenta que las bases o bancos de datos, o cualquier clase de repositorios electrónicos, son creaciones protegidas por el Derecho de Autor en favor de su autor o titular. De igual forma, se deberá tener en cuenta y aplicar en lo que sea pertinente las normas sobre protección de datos personales y Habeas Data; así como las normas en contra de los denominados delitos informáticos o cometidos a través de medios informáticos. 

En consecuencia, es la Universidad de los Andes, como titular de derechos sobre la base o banco de datos, quien puede o no, autorizar el uso o disposición de la misma a terceros o a sus unidades académicas. 
