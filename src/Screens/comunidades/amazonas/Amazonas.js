			...
			<div className="detail">
				...
				<div className="description">
					...
					<p>
						...
						en las cuencas. El desarrollo del proyecto se realiza con colaboración de la universidad de
						Bath del Reino Unido donde por medio de diferentes tecnologías se quiere conocer el estado
						del agua.
					</p>
					<ul>
						<li>
							Talleres con la comunidad para mostrar la importancia del cuidado y monitoreo de la cuenca.
						</li>
					</ul>
				</div>
				<div className="description">
